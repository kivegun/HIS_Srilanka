...
//pager starts
$form["CAPTION"]  = "Lab test department <input type=\'button\' class=\'btn btn-xs btn-success\' onclick=self.document.location=\'".site_url('lab_test/create_lab_test_department')."\' value=\'Add new Department\'>";
