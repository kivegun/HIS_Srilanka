...
//pager starts
$form["CAPTION"] = "User Group <input type=\'button\' class=\'btn btn-xs btn-success\' onclick=self.document.location=\'" . site_url('user_group/create') . "\' value=\'Add new\'>";
...
$form["ORIENT"] = "L";
$form["LIST"] = array('UGID', 'Name', 'Active', 'Remarks', 'MainMenu');
$form["DISPLAY_LIST"] = array('Id', 'Name', 'Active', 'Remarks', 'Main Menu');
//pager ends
$form["FLD"] = array(
    array(
        "id" => "Name",
