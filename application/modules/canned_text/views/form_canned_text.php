<div class='content' xmlns="http://www.w3.org/1999/html">
    <div id="mdsHead" class="mdshead">Canned text edit/new</div>

            <?php
            $form_generator = new MY_Form('Canned_text');
            $form_generator->form_open_current_url();
            $form_generator->input('*Code', 'code', $default_code, 'Code for the canned text');
            $form_generator->input('*Text', 'text', $default_text, 'Canned text');
