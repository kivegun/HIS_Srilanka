<div class="content">
    ...
    <?php
            ...
            $form_generator->input_number('Weight in KG', 'weight', $default_weight, 'min=0 max=300 step=5');
            $form_generator->input_number('Height in M', 'height', $default_height, 'min=0 max=2.5 step=0.1');
            ...
            $form_generator->input_with_default_value_button('Temperature in *C', 'Temperature', $default_temperature, 'min=15 max=50 step=0.5 normal=36,6', '36.6');
