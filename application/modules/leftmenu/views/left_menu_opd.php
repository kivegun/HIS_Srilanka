<div id='left-sidebar'>
    <div class='basic' style='float:left;'  id='list1'>
        ...
        <div>
            ...
            <input type='button' class='submenuBtn' <?php echo $css_menu_time ?> value='Order LabTest'  onclick="javascript:location.href='<?php echo base_url() ?>index.php/patient_lab_order/create/<?php echo $pid ?>/<?php echo $opdid ?>'">
